...
def process_chunk(args):
    ...
    target_seq_complement = str(Seq(target_seq).complement())
    ...
    with gzip.open(r1_file, "rt") as handle1, \
        ...
        for r1, r2 in zip(records1, records2):
            if (target_seq in r1.seq or target_seq_rc in r1.seq or 
                target_seq_complement in r1.seq or target_seq_reverse in r1.seq or
                target_seq in r2.seq or target_seq_rc in r2.seq or 
                target_seq_complement in r2.seq or target_seq_reverse in r2.seq):
                SeqIO.write(r1, out1, "fastq")
                SeqIO.write(r2, out2, "fastq")
                count += 1

    return count, output_r1, output
